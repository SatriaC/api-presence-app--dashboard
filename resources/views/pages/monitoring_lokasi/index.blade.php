...
@section('title', 'Monitor Lokasi')
@section('content')
    <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Monitor Lokasi</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">BM</a></li>
                <li class="breadcrumb-item active" aria-current="page">Monitor Lokasi</li>
            </ol>
        </div>
        <div class="d-flex">
            ...
            <div class="card custom-card">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content modal-content-demo">
                                    <div class="modal-header">
                                        <h6 class="modal-title">Tambah Data Lokasi</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive border">
                        <table id="lokasiTable" class="table text-nowrap text-md-nowrap table-hover mg-b-0">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama</th>
...
<script>
    $(function() {
        moment.locale('id');
        var datatable = $('#lokasiTable').DataTable({
            processing: true,
            serverSide: true,
            ordering: true,
            ajax: {
