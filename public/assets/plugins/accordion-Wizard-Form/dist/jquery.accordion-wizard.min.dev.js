...
!function (a, t, e, s) {
  ...
  var n = "accWizard",
    ...
    stepNumbers: !0,
    stepNumberClass: "",
    beforeNextStep: function beforeNextStep(t) {
      return !0;
    },
  ...
  a.extend(c.prototype, {
    init: function init() {
      ...
      this.$steps = a("[data-acc-step]"), this.stepHeight = a("[data-acc-step]").eq(0).outerHeight(), this.settings.stepNumbers && this.$steps.each(function (t, e) {
        ...
        if (0 < t && s.append('<a href="#" class="' + i.settings.autoButtonsPrevClass + '" data-acc-btn-prev>Back</a>'), t < i.$steps.length - 1) s.append('<a href="#" class="' + i.settings.autoButtonsNextClass + '" data-acc-btn-next>Next</a>');else if (i.settings.autoButtonsShowSubmit) {
    ...
    deactivateStep: function deactivateStep(t, e) {
      this.$steps.eq(t).removeClass("active");
    },
    activateStep: function activateStep(t, e) {
    ...
    activateAllSteps: function activateAllSteps() {
